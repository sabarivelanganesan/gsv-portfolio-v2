    ...
    return (
        <div id="aboutme" className="aboutme">
            ...
            <div className="aboutme-details">
                ...
                <p className="abtme-description">Software Engineer with 4+ years of experience in building secure, scalable, and cloud-native solutions. Proficient in Java, Spring Boot, React, AWS, Docker, and Kubernetes, with strong expertise in vulnerability remediation (SCA, SAST, DAST) and automated security workflows. Experienced in designing microservices, optimizing database performance, and integrating CI/CD pipelines using Harness and Power Automate for secure EKS deployments. Passionate about intelligent automation, test-driven development, and continuous improvement. A proactive collaborator and technical mentor dedicated to delivering reliable, high-performance software aligned with business goals.</p>
